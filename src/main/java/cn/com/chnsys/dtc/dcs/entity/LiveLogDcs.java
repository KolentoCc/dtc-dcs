 ...
 * @version 1.0.0
 */
public class LiveLogDcs extends BaseEntity {
    ...
    public String toString() {
        return "[LiveLog = ]"+" caseId =" +caseId+" playWay =" +playWay+" openCourtInfoId =" +openCourtInfoId+" playUserName =" +playUserName+" playUserId =" +playUserId+" clientIP =" +clientIP+" logId =" +logId+" caseNum =" +caseNum+" playEndTime =" +playEndTime+" playStartTime =" +playStartTime;
    }
}
